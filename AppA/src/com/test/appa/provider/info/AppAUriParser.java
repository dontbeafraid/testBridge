 ...
 */
public class AppAUriParser extends UriMatcher {
    ...
    private static final Map<Integer, Integer> URI_ID_MAP = new HashMap<Integer, Integer>();
    ...
    private static final Map<Integer, Integer> URI_LOOKUP_KEY_MAP = new HashMap<Integer, Integer>();
        ...
        if (path != null) {
            ...
            if (tokens != null) {
                ...
                for (int i = 0; i < tokens.length; i++) {
                    ...
                    if (token.equals(ID_SEGMENT)) {
                        URI_ID_MAP.put(code, i);
                    } else if (token.equals(WILDCARD_SEGMENT)) {
                        if (afterLookup) {
                            URI_LOOKUP_KEY_MAP.put(code, i);
                        }
                    }
                    afterLookup = false;
                }
